          ...
          <div className="hidden lg:block space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="rounded-xl border bg-white/70 backdrop-blur-sm p-5 shadow-sm hover:shadow-md transition">
                <div className="h-6 w-6 text-orange-600 font-bold text-xl">M</div>
              ...
              <div className="rounded-xl border bg-white/70 backdrop-blur-sm p-5 shadow-sm hover:shadow-md transition">
                <div className="h-6 w-6 text-orange-600 font-bold text-xl">D</div>
                <h3 className="mt-3 font-semibold text-gray-900">
                  데이터 분석
                </h3>
                <p className="mt-1 text-sm text-gray-600">
            ...
            <p className="text-xs text-gray-500">© 2025 DDP Platform - Admin Portal</p>
          </div>
